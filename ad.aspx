<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ad.aspx.cs" Inherits="DBLABPROJECT.ad" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="col">
        ...
        <div class="form-group">
            <asp:FileUpload ID="CarImageFileUpload" runat="server" required CssClass="form-control" />
        </div>
    </div>
</div>
                            </div>
